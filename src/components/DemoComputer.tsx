...
Command: npx gltfjsx@6.5.3 public/models/computer.glb --transform --types 
Files: public/models/computer.glb [273.04KB] > /home/karun/projects/portfolio/computer-transformed.glb [269.88KB] (1%)
*/
...
type DemoComputerProps = React.ComponentProps<"group"> & {
  texture: string;
};
